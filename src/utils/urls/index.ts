...
export const STUDENTS_URL = (page: number = 1, size: number = 10) =>
    `/user?role=student&&take=${size}&&page=${page}`;
...
export const GROUPS_URL = (page: number = 1, size: number = 10) =>
    `/group?take=${size}&&page=${page}`;

export const UPLOAD_URL = "/aws";
export const UPLOAD_DELETE_URL = "/aws/delete";

export const TESTS_URL = (page: number = 1, size: number = 10) =>
    `/question?take=${size}&&page=${page}`;

export const DEPARTMENTS_URL = (page: number = 1, size: number = 10) =>
    `/question/category?take=${size}&&page=${page}`;

export const EXAMS_URL = (page: number = 1, size: number = 10) =>
    `/exam?take=${size}&&page=${page}`;
export const EXAM_CATEGORIES_URL = (page: number = 1, size: number = 10) =>
    `/exam/category?take=${size}&&page=${page}`;
